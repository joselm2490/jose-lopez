...
if (!file_exists($tcpdfPath)) {
    die("Error: No se pudo encontrar la librería TCPDF en $tcpdfPath");
}
...
try {
    ...
    <div>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="50%"><div class="name">José López<br>Ingeniero en Informática</div></td>
            </tr>
        </table>
    ...
    // Forzar los headers primero
    header('Content-Type: application/pdf');
    header('Content-Disposition: attachment; filename="CV_Jose_Lopez.pdf"');
